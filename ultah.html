...
<body>
   ...
   <div id='Content'>
     ...
     <p id="ket">Klik Kadonya Ya Sayangkuuu 🥰!</p>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       <p id="kalimat">Saya Ada something Buat Ayangku nih😚❤️</p>

       <p id="pesan1">Ayang Klik dulu 4 LOVE yg Bawah ni! 😆❤️</p>
       <div id="kolombaru">
         <li id="lv1">🤍</li>
         <li id="lv2">🤍</li>
         <li id="lv3">🤍</li>
       ...
       <p id="pesan2">Nungguinn yaakkk🤪...</p>
       <!-- Pesan -->
       <p id="pesan3">Selamaat Ulang Tahun Sayangkuu 🤗❤️</p>
       <p id="pesan4">Happy Birthday yahh, </p>
       <p id="pesan5" class="gaya2">Nambah tua aja ya, hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur biar tiap hari bisa traktirin sayaa jajan ehehe 😆❤️</p>
       <p id="pesan7" class="gaya2">Sehat selalu ya sayangku🤗!</p>

       <p id="pesan8" class="gaya2">Canda wkwwk :v</p>
       <p id="pesan9" class="gaya2">Oh iya, semoga di hari spesial ny sayang hari ini ayang bisa menjadi lebih baik,, makin sayang sayaa,, rejeki lancar dan semogaa semua yg akan datang buat kita sesuatu yg baik yahh,, mwaaaaaahhh 🥳❤️</p>
       <p id="pesan10" class="gaya2">Happy Level Up Day Sayaangkuu!! 🥳</p>

       <!-- Tombol Lanjut -->
       <p id="opsL">Pencet Sek Incik Bos</p>
     </blockquote></div>
     ...
     <!-- Pesan Tambahan -->
     <p id="katatambahan" class="sembunyi">Gajadi deh soalnya ayang so mambu wleee 😜</p>
     
     <!-- Pesan Ditolak -->
     <div id="pesanditolak">
       <img id="stikerditolak" src="https://feeldreams.github.io/weee.gif"/>
       <p id="kataditolak">Yaudah kalo gamau mh,, padahal saya dah siapin bh tobrut🙄 😜</p>
     </div>
...
<script>
  ...
  async function inipesan(){
    var { value: nama } = await swals.fire({
           title: 'Masukin Panggilan Saya ke ayang yahh', input: 'text',
       });
       if(nama && nama.length < 11){
         ...
         mulainama();
           ...
           await swals.fire('Ups!', 'Nama tidak boleh kosong atau lebih dari 10 karakter, ya bees!');inipesan();
    }
  }

  //Variable Pertanyaan Akhir
  var tanya = 'Mau Kado Gak Nih Ayang? 😌❤️';
